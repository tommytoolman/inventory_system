"""
VintageAndRare Inventory Manager

This module provides functionality for interacting with the VintageAndRare website,
particularly for downloading inventory data as CSV and loading it directly into memory.

Classes:
    VRInventoryManager: Handles authentication and data export from VintageAndRare
"""
