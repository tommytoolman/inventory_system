...
class Settings(BaseSettings):
    ...
    DISCORD_LOGGING_ENABLED: bool = True
    DISCORD_BATCH_INTERVAL: float = 5.0   # seconds between Discord flushes
    DISCORD_QUEUE_LIMIT: int = 1000       # max records held in memory
