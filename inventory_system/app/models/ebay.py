...
from .platform_common import ListingStatus  # noqa: F401
...
class EbayListing(Base):
    ...
    ebay_item_id = Column(String, index=True)
    ...
    __table_args__ = (UniqueConstraint("tenant_id", "ebay_item_id", name="uq_ebay_item_per_tenant"),)
