...
from app.core.enums import PlatformName  # noqa: F401
...
class SyncEvent(Base):
    ...
    sync_run_id = Column(PG_UUID(as_uuid=True), index=True, nullable=False)
    ...
    def __repr__(self):
        return (
            f"<SyncEvent(id={self.id}, run_id={self.sync_run_id}, platform='{self.platform_name}', "
