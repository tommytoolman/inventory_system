...
class ReverbImporter:
    ...
    def _map_condition(self, listing_data: Dict[str, Any]) -> str:
        ...
        # NOTE: "brand new" must come before "good" — substring matching is used below,
        # and "good" would not match "brand new", but ordering makes the intent explicit.
        condition_map = {
            "brand new": ProductCondition.NEW.value,
