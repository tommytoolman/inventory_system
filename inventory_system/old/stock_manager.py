...
from app.integrations_old.base import PlatformInterface, SyncStatus
from app.integrations_old.events import StockUpdateEvent
from app.integrations_old.metrics import MetricsCollector, MetricsContext  # New import
